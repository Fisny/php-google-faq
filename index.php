...
$array = [
    ...
    [
        ...
        'risposta' => 'Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:<ul><li>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:</li><br><ul><li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell\'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li><br><li>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li><br></ul><li>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li></ul>Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account.',
    ],
    [
        'domanda' => '',
        'risposta' => '',
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col d-flex justify-content-between align-items-center">
                <div>
                    <a href="https://policies.google.com/"><img class="google-img" src="https://loghi-famosi.com/wp-content/uploads/2020/09/Google-Logo.png" alt=""></a>
                    <a class="termini" href="https://policies.google.com/" alt="Privacy e termini">Privacy e termini</a>
                </div>

                <div>
                    <a href="https://policies.google.com/"><i class="fas fa-bars"></i></a>
                    <a class="termini" href="https://policies.google.com/" alt="Privacy e termini"><i class="fas fa-user"></i></a>
                </div>
        ...
        <div class="row info">
            <div class="col barra">
                <a href="https://policies.google.com/">Introduzioni</a>
...
<?php
    foreach($array as $singola){ ?>
        <div class="container">
                <div class="php">
                    <h2 class="titolo"> <?php echo $singola['domanda'] ?> </h2>
                    <p class="paragrafo"> <?php echo $singola['risposta'] ?> </p>
                </div>
        </div>
    <?php }
?>
